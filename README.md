...
Open Control Panel and select Programs, then click __Turn Windows features on or off__. In the list, make sure Internet Information Services (IIS) is enabled. Under Internet Information Services &#8594; World Wide Web Services &#8594; Application Development Features, enable CGI. 
